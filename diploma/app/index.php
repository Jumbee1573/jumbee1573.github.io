					...
					<li>
						...
						<li onclick="menuClose()">
								<? if(isset($_SESSION['logged_student'])) :
									echo '<a href="./php/students-menu.php" 
							...
							<li onclick="menuClose()">
								<? if(isset($_SESSION['logged_teacher'])) : 
									echo '<a href="./php/teachers-menu.php" 
			...
			<nav class="header__menu" id="header__menu">
				...
				<div class="header__menu_authorization">
					<ul>
						<li class="header__menu_item">
							<? if(isset($_SESSION['logged_student'])) : 
								echo '<a href="./php/students-menu.php">'.$studentName.'</a>'; 
							?>
							<? else : 
								echo '<a href="./php/students.php">Студент</a>'; 
							?>
							<? endif; ?>
						</li>
						<li class="header__menu_item">
							<? if(isset($_SESSION['logged_teacher'])) : 
								echo '<a href="./php/teachers-menu.php">'.$teacherName.'</a>'; 
							?>
							<? else : 
								echo '<a href="./php/teachers.php" 
						...
						<a href="./php/jquery0.php" class="flex">
							...
							<div class="course__segment_main_wrapper">
								...
								<p class="course__segment_description">
									...
									Ad nostrum, maiores laboriosam possimus ut est odit sunt 
									praesentium consequuntur vero.
								</p>
							</div>
						</a>
					</div>
